...
# filter tidied expression data to keep only significantly differentially expressed genes
...
(ref:lda-fig) Histogram plot of first linear discriminant (LD1) scores for each ash tree sampled, with their susceptibility to Chalara ash dieback shown as indicated by the legend. The gene `r load_ld1` has the highest value in the LD1 so correlates with this dimension. There is a strong separation between trees with different traits.
